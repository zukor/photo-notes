...
out('evidence',JSON.stringify({id:issue.id,issue_type:issue.issue_type,approved_ui_instructions:['ui_improvement','feature_improvement'].includes(issue.issue_type)&&issue.review_decision==='implement'?issue.implementation_instructions:null,description:issue.description,page_name:issue.page_name,edition:issue.reported_edition,viewport:issue.viewport,reporter_details:issue.reporter_details,has_screenshot:issue.has_screenshot,has_voice:issue.has_voice,history:q.history.filter(h=>h.issue_id===issue.id).slice(0,10)}));
