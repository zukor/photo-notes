(function () {
  ...
  const ES = {
    ...
    'Photo History': 'Historial de la foto', 'Notes': 'Notas', 'No notes added.': 'No se agregaron notas.', 'See when this photo note was saved and what was changed later. Your private note text is not shown in this history.': 'Vea cuándo se guardó esta nota fotográfica y qué se cambió después. El texto privado de la nota no aparece en este historial.',
