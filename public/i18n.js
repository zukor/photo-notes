(function () {
  ...
  const ES = {
    ...
    "Enter the correct address or geographic area:": "Ingrese la dirección o zona geográfica correcta:",
    "Open in Photo Library": "Abrir en la biblioteca de fotos",
    "Delete Record": "Eliminar registro",
    "Delete this saved scanner record? Photos already added to the library are kept.": "¿Eliminar este registro escaneado? Las fotos ya agregadas a la biblioteca se conservarán.",
    "Add to Document...": "Agregar al documento...",
    "Preparing Word template preview...": "Preparando la vista previa de la plantilla de Word...",
    "Open the printable PDF version": "Abrir la versión PDF para imprimir",
    "Word preview could not be loaded. Try again or download Word.": "No se pudo cargar la vista previa de Word. Reintente o descargue Word.",
    "Getting location...": "Obteniendo ubicación...",
    "Waiting for GPS coordinates...": "Esperando las coordenadas GPS...",
    "Looking up address...": "Buscando la dirección...",
    "Location permission is blocked for this site.": "El permiso de ubicación está bloqueado para este sitio.",
    "Location timed out or is unavailable.": "Se agotó el tiempo de espera de la ubicación o no está disponible.",
    "Tap Retry location and address, or save without an address.": "Toque Reintentar ubicación o guarde sin dirección.",
    "No speech was received. On iPhone, tap the note box and use the keyboard microphone, or try Record Notes again.": "No se recibió voz. En iPhone, toque el cuadro de notas y use el micrófono del teclado, o toque Grabar notas de nuevo.",
    "Speech received.": "Voz recibida.",
    "Listening. On iPhone, words may appear after you pause.": "Escuchando. En iPhone, las palabras pueden aparecer después de una pausa.",
    "Please wait for this photo to finish saving locally.": "Espere a que esta foto termine de guardarse en el dispositivo.",
    "This ticket number, plant and date are already saved. The duplicate was not added.": "Este número de boleto, planta y fecha ya están guardados. No se agregó el duplicado.",
    ...
    "Tell us what should have happened": "Indique qué debería haber sucedido",
    "For example: record a note after taking a photo": "Por ejemplo: grabar una nota después de tomar una foto",
    "Choose one": "Elija una opción",
    "Every time": "Siempre",
    "Sometimes": "A veces",
    "Only happened once": "Solo ocurrió una vez",
    "Not sure": "No estoy seguro",
    "Record Voice Description": "Grabar descripción de voz",
    "Record Again": "Grabar de nuevo",
    "Recording... tap to stop": "Grabando... toque para detener",
    "Saving voice recording...": "Guardando grabación de voz...",
    "Voice recording attached. You may also type a description.": "Grabación de voz adjunta. También puede escribir una descripción.",
    "Recording your voice. Tap the blue button when you are finished.": "Grabando su voz. Toque el botón azul cuando termine.",
    "Answer these short questions. Photo Notes attaches the page and device details automatically.": "Responda estas preguntas breves. Photo Notes adjunta automáticamente los detalles de la página y del dispositivo.",
    "Text": "Texto",
    "Color": "Color",
    "Undo": "Deshacer",
    "Zoom": "Zoom",
    ...
    "Optional header": "Encabezado opcional",
    "Footer Text": "Texto del pie de página",
    "Optional footer or contact information": "Pie de página o información de contacto opcional",
    "Save Branding Text": "Guardar textos de la marca",
    "Company Logo": "Logotipo de la empresa",
    "No logo uploaded": "No se ha cargado un logotipo",
    "Uploaded company logo": "Logotipo de empresa cargado",
    "Upload Logo": "Cargar logotipo",
    "Word Template": "Plantilla de Word",
    "No template uploaded": "No se ha cargado una plantilla",
    "Use a .docx file containing": "Use un archivo .docx que contenga",
    ". Optional placeholders:": ". Marcadores opcionales:",
    ", and": ", y",
    "Download Starter Template": "Descargar plantilla inicial",
    "Import Word Template": "Importar plantilla de Word",
    "Branding saved": "Marca guardada",
    "Branding could not be saved": "No se pudo guardar la marca",
    "Logo uploaded": "Logotipo cargado",
    "Word template imported": "Plantilla de Word importada",
    "Logo removed": "Logotipo eliminado",
    "Template removed": "Plantilla eliminada",
    "Typeface": "Tipo de letra",
    "Photo Arrangement": "Distribución de fotos",
    "One photo per page": "Una foto por página",
    "Two photos per page": "Dos fotos por página",
    ...
    "Layout could not be saved": "No se pudo guardar el diseño",
    "Add photos from Organize to preview the document.": "Agregue fotos desde Organizar para ver la vista previa del documento.",
    "Photo Notes Test Checkout": "Pago de prueba de Photo Notes",
    ...
    "Fences & Walls": "Cercas y muros",
    "Fences & walls": "Cercas y muros",
    "No Topic": "Sin tema",
    "No topic": "Sin tema",
    "Change Photo Title": "Cambiar título de foto",
    "Photo Title": "Título de foto",
    "Add a short descriptive title": "Agregue un título descriptivo breve",
    "Save Title": "Guardar título",
    "Enter a photo title": "Ingrese un título de foto",
    "Photo title saved": "Título de foto guardado",
    "Photo title could not be saved": "No se pudo guardar el título de foto",
    "Close photo viewer": "Cerrar visor de fotos",
    "Viewing only. Drag the photo with a finger or mouse, or use the controls below.": "Solo visualización. Arrastre la foto con el dedo o el ratón, o use los controles de abajo.",
    "Zoom In": "Acercar",
    "Zoom Out": "Alejar",
    ...
    "Reset Photo": "Restablecer foto",
    "Share the original photos, or download a PDF, Word document, or AI-ready package.": "Comparta las fotos originales o descargue un PDF, un documento de Word o un paquete preparado para IA.",
    "Share or Download Selected Captures": "Compartir o descargar capturas seleccionadas",
    "Clear All": "Borrar todo",
    "Download": "Descargar",
    "Share": "Compartir",
    "Download format": "Formato de descarga",
    "Untitled Photo": "Foto sin título",
    "Unfiled": "Sin archivar",
    "No notes": "Sin notas",
    "All captures selected": "Todas las capturas seleccionadas",
    "Selection cleared": "Selección borrada",
    "Payments": "Pagos",
    "Payment": "Pago",
    "Pay securely on Stripe’s hosted checkout page.": "Pague de forma segura en la página de pago de Stripe.",
    "Pay with Stripe": "Pagar con Stripe",
    "Opening Stripe...": "Abriendo Stripe...",
    "Stripe checkout could not be opened": "No se pudo abrir la página de pago de Stripe",
    "Topics for this photo": "Temas de esta foto",
    "Save Topics": "Guardar temas",
    "Photo topics saved": "Temas de foto guardados",
    "Photo topics could not be saved": "No se pudieron guardar los temas de foto",
    "Markdown + Photos": "Markdown + Fotos",
    "Markdown + Photos (.zip)": "Markdown + Fotos (.zip)",
    "Markdown + Photos downloads one ZIP file containing an AI-readable Markdown document and the original photos.": "Markdown + Fotos descarga un archivo ZIP con un documento Markdown legible por IA y las fotos originales.",
    "Open the PDF for printing": "Abrir el PDF para imprimir",
    "Printing is available for PDF documents": "La impresión está disponible para documentos PDF",
    'Patio':'Patio', 'Driveway':'Entrada vehicular', 'Slab':'Losa', 'Foundation':'Cimentación', 'Steps':'Escalones', 'Curb':'Guarnición', 'Wall':'Muro', 'Column':'Columna', 'Beam':'Viga', 'Deck':'Terraza',
    "Concrete Project Photos": "Fotos del proyecto de concreto",
    "Plan a proposal, document the work, show the finished result, or revisit a project.": "Prepare una propuesta, documente el trabajo, muestre el resultado final o vuelva a visitar un proyecto.",
    "Project phase": "Etapa del proyecto",
    "Photo purpose": "Motivo de la foto",
    "Choose a phase (optional)": "Elija una etapa (opcional)",
    "Choose a photo purpose (optional)": "Elija el motivo de la foto (opcional)",
    "Choose a phase first": "Primero elija una etapa",
    "Choose a phase for photo ideas, or take a photo and add your notes.": "Elija una etapa para ver ideas de fotos, o tome una foto y agregue sus notas.",
    "Before the proposal": "Antes de la propuesta",
    "While doing the work": "Durante el trabajo",
    "When the work is finished": "Al terminar el trabajo",
    "Later visit or follow-up": "Visita posterior o seguimiento",
    "Photograph the space and what the customer wants, even when no concrete exists yet.": "Fotografíe el espacio y lo que quiere el cliente, incluso cuando todavía no hay concreto.",
    "Document progress, details that will be covered, and changes as the work happens.": "Documente el avance, los detalles que quedarán cubiertos y los cambios durante el trabajo.",
    "Show the finished result, completed scope, and details for the customer handoff.": "Muestre el resultado final, el trabajo realizado y los detalles para la entrega al cliente.",
    "Revisit the project, document a reported concern, or follow a repair through completion.": "Vuelva a visitar el proyecto, documente un problema reportado o siga una reparación hasta terminarla.",
    "Proposed patio, driveway, or sidewalk": "Patio, entrada o banqueta propuesta",
    "Existing conditions or damage": "Condiciones o daños existentes",
    "Layout and measurements": "Distribución y medidas",
    "Access for crew and equipment": "Acceso para personal y equipo",
    "Slope and drainage": "Pendiente y drenaje",
    "Removal and site preparation needed": "Retiro y preparación necesarios",
    "Customer requests and scope": "Solicitudes del cliente y alcance",
    "Finish or design reference": "Referencia de acabado o diseño",
    "Demolition and excavation": "Demolición y excavación",
    "Base preparation": "Preparación de la base",
    "Forms and layout": "Cimbras y trazado",
    "Reinforcement and embedded items": "Refuerzo y elementos empotrados",
    "Before the pour": "Antes del colado",
    "Concrete delivery and batch ticket": "Entrega de concreto y comprobante",
    "Concrete placement": "Colocación del concreto",
    "Finishing and joints": "Acabado y juntas",
    "Curing and protection": "Curado y protección",
    "Change or extra work": "Cambio o trabajo adicional",
    "Problem during the work": "Problema durante el trabajo",
    "Finished project overview": "Vista general del proyecto terminado",
    "Finish, edges, and joints": "Acabado, bordes y juntas",
    "Completed layout and measurements": "Distribución final y medidas",
    "Drainage check": "Revisión del drenaje",
    "Cleanup and surrounding property": "Limpieza y propiedad circundante",
    "Customer walkthrough or punch list": "Recorrido con el cliente o pendientes",
    "After photo for comparison": "Foto posterior para comparar",
    "Scheduled revisit or condition check": "Visita programada o revisión de condición",
    "Reported problem or concern": "Problema o inquietud reportada",
    "Monitor a change over time": "Seguir un cambio con el tiempo",
    "Repair work": "Trabajo de reparación",
    "After repair or final check": "Después de reparar o revisión final",
    "Project details (optional)": "Detalles del proyecto (opcionales)",
    "Project type": "Tipo de proyecto",
    "Choose project type": "Elija el tipo de proyecto",
    "Project / job": "Proyecto / trabajo",
    "No project selected": "Ningún proyecto seleccionado",
    "Where on the property?": "¿En qué parte de la propiedad?",
    "Backyard patio area, front driveway, or side walkway": "Área del patio trasero, entrada frontal o pasillo lateral",
    "Observed condition (optional)": "Condición observada (opcional)",
    "Severity (optional)": "Gravedad (opcional)",
    "Not rated": "Sin calificar",
    "Not assessed": "Sin evaluar",
    "Repair needed": "Requiere reparación",
    "Mix or specification (optional)": "Mezcla o especificación (opcional)",
    "Record only a confirmed mix or specification": "Anote solo una mezcla o especificación confirmada",
    "Sidewalk / walkway": "Banqueta / pasillo",
    "Show the whole area and where the new concrete could go.": "Muestre toda el área y dónde podría colocarse el concreto nuevo.",
    "Record what is already there, including any problem the customer wants fixed.": "Documente lo que ya existe, incluido cualquier problema que el cliente quiera reparar.",
    "Photograph marked boundaries and tape or laser readings. Record measured dimensions in Notes.": "Fotografíe los límites marcados y las lecturas de cinta o láser. Anote las medidas en Notas.",
    "Show gates, narrow passages, delivery access, and obstacles.": "Muestre puertas, pasos estrechos, acceso para entregas y obstáculos.",
    "Show slopes, low spots, downspouts, and where water collects or flows.": "Muestre pendientes, zonas bajas, bajantes y dónde se acumula o fluye el agua.",
    "Show concrete, soil, plants, or other material that may need to be removed.": "Muestre concreto, tierra, plantas u otro material que pueda necesitar retirarse.",
    "Photograph the area while recording what the customer wants included or left alone.": "Fotografíe el área mientras registra lo que el cliente quiere incluir o dejar sin cambios.",
    "Capture a sample, color, texture, or nearby example the customer likes.": "Capture una muestra, color, textura o ejemplo cercano que le guste al cliente.",
    "Show removal progress, excavation, and any newly exposed conditions.": "Muestre el avance del retiro, la excavación y las condiciones descubiertas.",
    "Show the prepared base and any measured depth before it is covered.": "Muestre la base preparada y la profundidad medida antes de cubrirla.",
    "Show form positions, edges, slopes, and layout measurements.": "Muestre la posición de las cimbras, los bordes, las pendientes y las medidas del trazado.",
    "Photograph reinforcement and embedded items before the pour covers them.": "Fotografíe el refuerzo y los elementos empotrados antes de que el colado los cubra.",
    "Capture the full prepared area and details you want on record before placement.": "Capture toda el área preparada y los detalles que quiera registrar antes de colocar el concreto.",
    "Photograph the delivery or ticket. Attach a ticket to its placement photo later if needed.": "Fotografíe la entrega o el comprobante. Después puede adjuntar el comprobante a la foto de colocación.",
    "Show the pour and progress across the work area.": "Muestre el colado y el avance en el área de trabajo.",
    "Photograph the surface finish, edges, and joints as they are made.": "Fotografíe el acabado, los bordes y las juntas mientras se realizan.",
    "Show how the fresh concrete and surrounding area are being protected.": "Muestre cómo se protege el concreto fresco y el área circundante.",
    "Photograph what changed and record the requested work and who discussed it.": "Fotografíe lo que cambió y registre el trabajo solicitado y con quién se habló.",
    "Record the location, visible condition, and what happened during this project.": "Registre la ubicación, la condición visible y lo que sucedió durante este proyecto.",
    "Show the completed patio, driveway, sidewalk, or other work from useful viewpoints.": "Muestre el patio, entrada, banqueta u otro trabajo terminado desde puntos de vista útiles.",
    "Capture close views of the completed surface and details.": "Capture vistas cercanas de la superficie terminada y sus detalles.",
    "Photograph the final boundaries and any measured dimensions.": "Fotografíe los límites finales y las dimensiones medidas.",
    "Record the conditions and observations during a drainage check, if one is performed.": "Registre las condiciones y observaciones durante una revisión del drenaje, si se realiza.",
    "Show cleanup, restored areas, and the condition of nearby property.": "Muestre la limpieza, las áreas restauradas y la condición de la propiedad cercana.",
    "Photograph walkthrough items and record what was discussed or still needs attention.": "Fotografíe los puntos del recorrido y anote lo que se habló o todavía necesita atención.",
    "Match the viewpoint of a before photo so the completed work can be compared.": "Use el mismo punto de vista de una foto anterior para comparar el trabajo terminado.",
    "Record how the work looks after time has passed and why you are revisiting.": "Registre cómo se ve el trabajo con el paso del tiempo y el motivo de la visita.",
    "Show the reported condition, its location, and when it was noticed.": "Muestre la condición reportada, su ubicación y cuándo se observó.",
    "Use the same viewpoint and include a scale where useful for later comparison.": "Use el mismo punto de vista e incluya una escala cuando ayude a comparar después.",
    "Photograph the condition being repaired and the repair progress.": "Fotografíe la condición que se está reparando y el avance de la reparación.",
    "Show the repaired area and record what was checked.": "Muestre el área reparada y anote lo que se revisó.",
    ...
    "Photo Note deleted": "Nota fotográfica eliminada",
    "Delete Photo Note": "Eliminar nota fotográfica",
    "Change Topics": "Cambiar temas",
    "View & Zoom": "Ver y ampliar",
    "Add Photo Title": "Agregar título de foto",
    "Untitled photo": "Foto sin título",
    "Saved Photo Notes appear here. Select any photos you want to organize or compare.": "Aquí aparecen las notas fotográficas guardadas. Seleccione las fotos que desea organizar o comparar.",
    "Current Photo Notes": "Notas fotográficas guardadas",
    "Your library": "Su biblioteca",
    "Replace Topics": "Reemplazar temas",
    "Add Topic": "Agregar tema",
    "Clear Selection": "Borrar selección",
    "Selection": "Selección",
    "Photo Note selection controls": "Controles de selección de notas fotográficas",
    "Select photos in the library below, then use only the action you need.": "Seleccione fotos en la biblioteca de abajo y luego elija la acción que necesita.",
    "Work with selected Photo Notes": "Trabajar con las notas fotográficas seleccionadas",
    "More search filters": "Más filtros de búsqueda",
    "Notes, jobs, customers, addresses, topics, dates, or defects": "Notas, trabajos, clientes, direcciones, temas, fechas o defectos",
    "Search Photo Notes": "Buscar notas fotográficas",
    "Filter by topic or search the details saved with each photo.": "Filtre por tema o busque en los datos guardados con cada foto.",
    "Find Photo Notes": "Buscar notas fotográficas",
    "Create a New Job": "Crear un trabajo nuevo",
    "Open or close": "Abrir o cerrar",
    "Job controls": "Opciones del trabajo",
    "Show Photo Notes from one job, review its timeline, or create a new job.": "Vea las notas fotográficas de un trabajo, revise su cronología o cree un trabajo nuevo.",
    "Choose a job": "Elija un trabajo",
    "Find the photos you need, select them, and choose what you want to do with them.": "Busque las fotos que necesita, selecciónelas y elija qué desea hacer con ellas.",
    "Organize your Photo Notes": "Organice sus notas fotográficas",
    ...
    'Paving Pro': 'Pavimentación Pro', 'HOA Maintenance Pro': 'Mantenimiento HOA Pro', 'Concrete Pro': 'Concreto Pro', 'Basic Plan': 'Plan Básico', 'Admin Dashboard': 'Panel de administración', 'Super Admin Dashboard': 'Panel de superadministración', 'Sign Out': 'Cerrar sesión',
    ...
    'Other Camera Tools': 'Otras herramientas de cámara', 'Note': 'Nota', 'Record Notes': 'Grabar notas',
    'Your recorded notes will appear here as words': 'Sus notas grabadas aparecerán aquí como palabras',
    ...
    'Before using AI, check this photo: a ruler, tape measure, or another object of known length must already be visible beside the area being measured. Selecting a reference below does not add it to the image. If this photo has no reference, enter Dimensions manually.': 'Antes de usar IA, revise esta foto: una regla, cinta métrica u otro objeto de longitud conocida ya debe estar visible junto al área que se va a medir. Seleccionar una referencia abajo no la agrega a la imagen. Si esta foto no tiene una referencia, ingrese las dimensiones manualmente.',
    ...
    'Record Voice Note': 'Grabar notas de voz', 'Customer / Client (optional)': 'Cliente (opcional)', 'Customer or client name': 'Nombre del cliente',
    ...
    'Allow microphone access for this site, then tap Record Notes again': 'Permita el acceso al micrófono para este sitio y después toque Grabar notas de nuevo',
    ...
    'Did not catch that. Tap Record Notes and speak again': 'No se entendió. Toque Grabar notas y vuelva a hablar', 'Dispatch Temperature (°F)': 'Temperatura de despacho (°F)',
    ...
    "Send Word or ZIP without downloading first": "Envíe Word o ZIP sin descargar primero",
    "Create a link to this file and send it in Teams, WhatsApp, or email. Anyone with the link can download it for 7 days. Revoke it from Shared document links in Send.": "Cree un enlace a este archivo y envíelo por Teams, WhatsApp o correo. Cualquier persona con el enlace puede descargarlo durante 7 días. Revóquelo desde Enlaces a documentos compartidos en Enviar.",
    "Create share link": "Crear enlace para compartir",
    "Creating link...": "Creando enlace...",
    "Link ready. Share or copy it below.": "Enlace listo. Compártalo o cópielo abajo.",
    "Share link": "Compartir enlace",
    "Copy link": "Copiar enlace",
    "Document download link": "Enlace de descarga del documento",
    "Link copied. Paste it in Teams, WhatsApp, or email.": "Enlace copiado. Péguelo en Teams, WhatsApp o correo.",
    "Select and copy the link, then paste it in your message.": "Seleccione y copie el enlace; luego péguelo en su mensaje.",
    "Link shared.": "Enlace compartido.",
    "Sharing was canceled. You can try again or copy the link.": "Se canceló el envío. Puede volver a intentarlo o copiar el enlace.",
    "Copy the link and paste it in Teams, WhatsApp, or email.": "Copie el enlace y péguelo en Teams, WhatsApp o correo.",
    "Link expires:": "El enlace vence:",
    "Shared document links": "Enlaces a documentos compartidos",
    "Loading shared links...": "Cargando enlaces compartidos...",
    "Anyone with a link can download that file until it expires or you revoke it.": "Cualquier persona con un enlace puede descargar el archivo hasta que venza o usted lo revoque.",
    "No active shared links.": "No hay enlaces compartidos activos.",
    "Revoke link": "Revocar enlace",
    "Link revoked. Recipients can no longer download the file through this link.": "Enlace revocado. Los destinatarios ya no pueden descargar el archivo mediante este enlace.",
    "This browser cannot share this file directly. Create a share link below, or use Download.": "Este navegador no puede compartir este archivo directamente. Cree un enlace abajo o use Descargar.",
    "This browser could not share the document. Create a share link below, or use Download.": "Este navegador no pudo compartir el documento. Cree un enlace abajo o use Descargar.",
    "Could not create the link. Please try again.": "No se pudo crear el enlace. Vuelva a intentarlo.",
    "Could not load shared links.": "No se pudieron cargar los enlaces compartidos.",
    "Could not revoke the link.": "No se pudo revocar el enlace.",
    "Revoke an existing shared link before creating another. The limit is 20 links or 100 MB.": "Revoque un enlace existente antes de crear otro. El límite es de 20 enlaces o 100 MB.",
    "Choose a PDF, Word, or ZIP document up to 20 MB.": "Elija un documento PDF, Word o ZIP de hasta 20 MB.",
    "The file could not be uploaded. Links support files up to 20 MB.": "No se pudo cargar el archivo. Los enlaces admiten archivos de hasta 20 MB.",
    "Automatic scanning is not set up yet. Your photo is available for manual entry.": "La lectura automática aún no está configurada. Su foto está disponible para ingresar los datos manualmente.",
    "Automatic scanning is unavailable because the service connection needs attention. Your photo is available for manual entry.": "La lectura automática no está disponible porque la conexión del servicio requiere atención. Su foto está disponible para ingresar los datos manualmente.",
    "Automatic scanning is unavailable because the service account needs attention. Your photo is available for manual entry.": "La lectura automática no está disponible porque la cuenta del servicio requiere atención. Su foto está disponible para ingresar los datos manualmente.",
    "Automatic scanning is busy or has reached its usage limit. Try again later, or enter the details manually.": "La lectura automática está ocupada o alcanzó su límite de uso. Inténtelo más tarde o ingrese los datos manualmente.",
    "Automatic scanning took too long. Try again, or enter the details manually.": "La lectura automática tardó demasiado. Inténtelo otra vez o ingrese los datos manualmente.",
    "The automatic scanning service is temporarily unavailable. Try again later, or enter the details manually.": "El servicio de lectura automática no está disponible temporalmente. Inténtelo más tarde o ingrese los datos manualmente.",
    "The scanning service returned an incomplete result. Try again, or enter the details manually.": "El servicio devolvió un resultado incompleto. Inténtelo otra vez o ingrese los datos manualmente.",
    "No readable details were found in this photo. Try a clearer photo, or enter the details manually.": "No se encontraron datos legibles en esta foto. Pruebe con una foto más clara o ingrese los datos manualmente.",
    "This photo could not be opened. Choose another image, or enter the details manually.": "No se pudo abrir esta foto. Elija otra imagen o ingrese los datos manualmente.",
    "The scan could not be completed. Your selected photo is still available. Try again.": "No se pudo completar la lectura. Su foto seleccionada sigue disponible. Inténtelo otra vez.",
    ...
    'Record deleted': 'Registro eliminado', 'Record saved': 'Registro guardado', 'Recording could not start. Tap Record Notes to try again': 'No se pudo iniciar la grabación. Toque Grabar notas para intentarlo de nuevo',
    'Recording stopped unexpectedly. Tap Record Notes to try again': 'La grabación se detuvo inesperadamente. Toque Grabar notas para intentarlo de nuevo',
    ...
    'Photo Details & History': 'Detalles e historial de la foto', 'Notes': 'Notas', 'No notes added.': 'No se agregaron notas.', 'See when this photo note was saved and what was changed later. Your private note text is not shown in this history.': 'Vea cuándo se guardó esta nota fotográfica y qué se cambió después. El texto privado de la nota no aparece en este historial.',
    'Original photo saved': 'Foto original guardada', 'Photo size:': 'Tamaño de la foto:', 'Location saved:': 'Ubicación guardada:', 'Address saved:': 'Dirección guardada:',
    'Original photo matches': 'La foto original coincide', 'Original photo does not match': 'La foto original no coincide', 'File check unavailable': 'La comprobación del archivo no está disponible',
    'Technical file details': 'Detalles técnicos del archivo', 'SHA-256 file ID': 'ID de archivo SHA-256', 'Not available for this older photo': 'No disponible para esta foto anterior', 'Changes': 'Cambios',
    ...
    'No change history is available for this older photo.': 'No hay historial de cambios disponible para esta foto anterior.', 'Photo history could not be loaded': 'No se pudo cargar el historial de la foto',
    ...
    'HOA / Community': 'HOA / Comunidad', 'Select Community': 'Seleccionar comunidad', 'Create your first community under Assets before saving a maintenance record.': 'Cree su primera comunidad en Activos antes de guardar un registro de mantenimiento.',
    ...
    'Visits': 'Visitas', 'Assets': 'Activos', 'Inspections': 'Inspecciones', 'Records': 'Registros',
    'Physical Asset Photo Registry': 'Registro fotográfico de activos físicos', 'Communities organize asset photos and inspection routes. This is not a general HOA directory.': 'Las comunidades organizan las fotos de activos y las rutas de inspección. Este no es un directorio general de la HOA.',
    'Photograph a New Asset': 'Fotografiar un activo nuevo', 'Property Address': 'Dirección de la propiedad', 'Asset Name': 'Nombre del activo', 'Asset Type': 'Tipo de activo', 'Exact Location': 'Ubicación exacta',
    'Current Condition': 'Condición actual', 'Not Assessed': 'Sin evaluar', 'Good': 'Buena', 'Fair': 'Regular', 'Poor': 'Mala', 'Critical': 'Crítica', 'Required Identity Photo': 'Foto de identificación obligatoria',
    'Save Asset Photo Record': 'Guardar registro fotográfico del activo', 'Asset Photo Records': 'Registros fotográficos de activos', 'All Communities': 'Todas las comunidades', 'Open Photo History': 'Abrir historial fotográfico',
    'Photo-Based Condition History': 'Historial fotográfico de condición', 'Back to Assets': 'Volver a Activos', 'Add Current Condition Photo': 'Agregar foto de condición actual', 'Photo Purpose': 'Propósito de la foto',
    'Condition Update': 'Actualización de condición', 'Damage': 'Daño', 'Repair Progress': 'Progreso de la reparación', 'Repair Verification': 'Verificación de la reparación', 'Updated Identity Photo': 'Foto de identificación actualizada',
    'Add Photo to Asset History': 'Agregar foto al historial del activo', 'Asset photo record saved': 'Registro fotográfico del activo guardado', 'Photo added to asset history': 'Foto agregada al historial del activo',
    'Photo Inspection Routes': 'Rutas de inspección fotográfica', 'Create an Inspection Route': 'Crear una ruta de inspección', 'Route Name': 'Nombre de la ruta', 'Route Instructions': 'Instrucciones de la ruta', 'Inspection Stops': 'Paradas de inspección',
    'Create Photo Route': 'Crear ruta fotográfica', 'Available Routes': 'Rutas disponibles', 'Start Property Visit': 'Iniciar visita a la propiedad', 'Photo inspection route created': 'Ruta de inspección fotográfica creada',
    'Property Maintenance Visit Mode': 'Modo de visita de mantenimiento de la propiedad', 'Start a Guided Property Visit': 'Iniciar una visita guiada a la propiedad', 'Property Visits': 'Visitas a la propiedad', 'Continue Visit': 'Continuar visita', 'Review Photos': 'Revisar fotos',
    'Back to Visits': 'Volver a Visitas', 'Required views:': 'Vistas obligatorias:', 'Inspection Note': 'Nota de inspección', 'Save Photos & Complete This Stop': 'Guardar fotos y completar esta parada', 'Visit Checklist': 'Lista de verificación de la visita',
    'Property visit complete.': 'Visita a la propiedad completada.', 'Every required stop has photographic documentation.': 'Cada parada obligatoria tiene documentación fotográfica.', 'Inspection stop documented': 'Parada de inspección documentada',
    'Request Completion Photos': 'Solicitar fotos de finalización', 'Recipient Name': 'Nombre del destinatario', 'Create Photo Submission Link': 'Crear enlace para enviar fotos', 'Private Photo Link': 'Enlace fotográfico privado',
    'Send this link to the person who will photograph the completed work.': 'Envíe este enlace a la persona que fotografiará el trabajo completado.', 'Photo link copied': 'Enlace fotográfico copiado',
    'Community': 'Comunidad', 'Create a visual record of the things the community maintains, then add condition, damage, repair, and verification photos over time.': 'Cree un registro visual de los elementos que mantiene la comunidad y agregue fotos de condición, daños, reparación y verificación con el tiempo.',
    'North entrance monument': 'Monumento de la entrada norte', 'Monument, light, gate, fence, playground...': 'Monumento, luz, portón, cerca, área de juegos...', 'North entrance, east side': 'Entrada norte, lado este',
    'What identifies this asset or its current condition?': '¿Qué identifica este activo o su condición actual?', 'No physical assets have been photographed yet.': 'Todavía no se ha fotografiado ningún activo físico.',
    'Define where to go and which photographic views must be captured. Each route becomes a guided Property Visit.': 'Defina adónde ir y qué vistas fotográficas se deben capturar. Cada ruta se convierte en una visita guiada a la propiedad.',
    'Start at the north entrance and walk clockwise.': 'Comience en la entrada norte y camine en el sentido de las agujas del reloj.', 'Enter one stop per line. Use a vertical bar to add required views, for example: North monument | overview, close-up, opposite side': 'Ingrese una parada por línea. Use una barra vertical para agregar vistas obligatorias, por ejemplo: Monumento norte | vista general, primer plano, lado opuesto',
    'No inspection routes have been created yet.': 'Todavía no se han creado rutas de inspección.', 'Follow a photo inspection route, see the next required location, and document every stop before leaving the property.': 'Siga una ruta de inspección fotográfica, vea la siguiente ubicación obligatoria y documente cada parada antes de salir de la propiedad.',
    'No property visits yet. Create a photo inspection route, then start the visit.': 'Todavía no hay visitas a la propiedad. Cree una ruta de inspección fotográfica y después inicie la visita.', 'Take all required views now. You can select several photos at once.': 'Tome ahora todas las vistas obligatorias. Puede seleccionar varias fotos a la vez.',
    'Create a private 14-day link. A contractor or other outside person can photograph the completed work without receiving access to Photo Notes.': 'Cree un enlace privado de 14 días. Un contratista u otra persona externa puede fotografiar el trabajo completado sin recibir acceso a Photo Notes.',
    'Streets and Pavement': 'Calles y pavimento', 'Sidewalks and Curbs': 'Aceras y bordillos', 'Drainage': 'Drenaje', 'Walls and Fencing': 'Muros y cercas', 'Gates and Access Control': 'Portones y control de acceso',
    'Landscaping and Irrigation': 'Jardinería y riego', 'Lighting and Electrical': 'Iluminación y electricidad', 'Signs and Pavement Markings': 'Señales y marcas del pavimento', 'Pools and Recreation': 'Piscinas y recreación',
  ...
  function dynamic(text, lang) {
    ...
    const rules = lang === 'es' ? [
      ...
      [/^Photo size: (.+)$/, 'Tamaño de la foto: $1'],
      [/^Location saved: (Yes|No) · Address saved: (Yes|No)$/, (_, g, a) => `Ubicación guardada: ${g === 'Yes' ? 'Sí' : 'No'} · Dirección guardada: ${a === 'Yes' ? 'Sí' : 'No'}`],
      [/^Original backup: (Preserved|Not currently needed)$/, (_, b) => `Respaldo original: ${b === 'Preserved' ? 'Conservado' : 'No necesario actualmente'}`],
