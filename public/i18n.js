(function () {
  ...
  const ES = {
    ...
    'HOA Maintenance Pro': 'Mantenimiento de HOA Pro', 'Maintenance': 'Mantenimiento', 'Communities': 'Comunidades', 'Dashboard': 'Panel', 'Reports': 'Informes',
    'HOA / Community': 'HOA / Comunidad', 'Select Community': 'Seleccionar comunidad', 'Create your first community under Communities before saving a maintenance record.': 'Cree su primera comunidad en Comunidades antes de guardar un registro de mantenimiento.',
    'Issue Title': 'Título del problema', 'Briefly identify the maintenance issue': 'Identifique brevemente el problema de mantenimiento', 'Record Type': 'Tipo de registro',
    'Maintenance Issue': 'Problema de mantenimiento', 'Information Request': 'Solicitud de información', 'Inspection Finding': 'Hallazgo de inspección', 'Priority': 'Prioridad',
    'Routine': 'Rutina', 'High': 'Alta', 'Emergency': 'Emergencia', 'Monitor': 'Monitorear', 'Maintenance Category': 'Categoría de mantenimiento',
    'Directed To': 'Dirigido a', 'Person expected to answer': 'Persona que debe responder', 'Select an HOA or community': 'Seleccione una HOA o comunidad', 'Enter an issue title or note': 'Ingrese un título o una nota',
    'Maintenance item saved': 'Elemento de mantenimiento guardado', 'Track every issue from the first photo through completed work and final review.': 'Dé seguimiento a cada problema desde la primera foto hasta el trabajo terminado y la revisión final.',
    'All Communities': 'Todas las comunidades', 'All Open Statuses': 'Todos los estados abiertos', 'All Priorities': 'Todas las prioridades', 'All Types': 'Todos los tipos',
    'Search titles, notes, communities, or categories': 'Buscar títulos, notas, comunidades o categorías', 'Show completed and cancelled': 'Mostrar completados y cancelados',
    'Open': 'Abiertos', 'High Priority': 'Prioridad alta', 'Overdue': 'Vencidos', 'Board Needed': 'Requiere junta', 'Needs Review': 'Necesita revisión',
    'New': 'Nuevo', 'Investigating': 'Investigando', 'Getting Pricing': 'Obteniendo precios', 'Board Decision Needed': 'Se necesita decisión de la junta', 'On Hold': 'En espera',
    'Approved': 'Aprobado', 'Scheduled': 'Programado', 'Work In Progress': 'Trabajo en curso', 'Waiting for Vendor': 'Esperando al proveedor', 'Waiting for Management': 'Esperando a administración',
    'Waiting for Board': 'Esperando a la junta', 'Work Done': 'Trabajo terminado', 'Completed': 'Completado', 'Deferred': 'Aplazado', 'Cancelled': 'Cancelado',
    'No maintenance items match this view.': 'Ningún elemento de mantenimiento coincide con esta vista.', 'Open Maintenance Record': 'Abrir registro de mantenimiento',
    'Not yet assigned': 'Aún no asignado', 'Back to Maintenance': 'Volver a Mantenimiento', 'Category': 'Categoría', 'Primary Assignee': 'Responsable principal',
    'Target Completion Date': 'Fecha objetivo de finalización', 'Budget Source': 'Fuente del presupuesto', 'Unassigned': 'Sin asignar', 'Operating Budget': 'Presupuesto operativo', 'Reserve Budget': 'Presupuesto de reservas',
    'Estimated Cost': 'Costo estimado', 'Actual Cost': 'Costo real', 'Board Approval': 'Aprobación de la junta', 'Not Required': 'No requerida', 'Requested': 'Solicitada',
    'On Meeting Agenda': 'En la agenda de la reunión', 'Rejected': 'Rechazada', 'More Information Requested': 'Se solicitó más información', 'Vendor or Completed By': 'Proveedor o completado por',
    'Required before completion': 'Obligatorio antes de completar', 'Completion Date': 'Fecha de finalización', 'Save Maintenance Record': 'Guardar registro de mantenimiento', 'Activity History': 'Historial de actividad',
    'Created': 'Creado', 'Updated': 'Actualizado', 'Maintenance record saved': 'Registro de mantenimiento guardado', 'Enter Vendor or Completed By before completing': 'Ingrese Proveedor o Completado por antes de finalizar',
    'Add a Community': 'Agregar una comunidad', 'Community Name': 'Nombre de la comunidad', 'Full Address': 'Dirección completa', 'Community Manager': 'Administrador de la comunidad', 'Add Community': 'Agregar comunidad',
    'No address entered': 'No se ingresó dirección', 'Not assigned': 'Sin asignar', 'No communities have been added yet.': 'Todavía no se han agregado comunidades.', 'Enter a community name': 'Ingrese el nombre de la comunidad',
    'Community added': 'Comunidad agregada', 'Community could not be added': 'No se pudo agregar la comunidad', 'Management Company & Team': 'Empresa administradora y equipo', 'Management Company Name': 'Nombre de la empresa administradora',
    'Team Members': 'Miembros del equipo', 'Add Existing HOA Maintenance Pro User': 'Agregar usuario existente de Mantenimiento HOA Pro', 'Employee email': 'Correo del empleado', 'Company name saved': 'Nombre de la empresa guardado',
    'Team member added': 'Miembro del equipo agregado', 'Management Dashboard': 'Panel de administración', 'Urgent work and accountability across every community.': 'Trabajo urgente y responsabilidad en todas las comunidades.',
    'Assigned to Me': 'Asignado a mí', 'All Open': 'Todos los abiertos', 'Notifications': 'Notificaciones', 'Mark All Read': 'Marcar todo como leído', 'No notifications yet.': 'Todavía no hay notificaciones.',
    'Maintenance Reports': 'Informes de mantenimiento', 'Review open, urgent, budget, and completed maintenance across the portfolio.': 'Revise el mantenimiento abierto, urgente, presupuestado y completado en toda la cartera.',
    'Print Current Report': 'Imprimir informe actual', 'All Budget Sources': 'Todas las fuentes de presupuesto', 'Operating': 'Operativo', 'Reserve': 'Reservas', 'Include completed work': 'Incluir trabajo completado',
    'Photo Documentation Timeline': 'Cronología de documentación fotográfica', 'Add Documentation Photo': 'Agregar foto de documentación', 'Photo Stage': 'Etapa de la foto',
    'Inspection': 'Inspección', 'Estimate or Proposal': 'Estimación o propuesta', 'Completed Work': 'Trabajo completado', 'Final Verification': 'Verificación final', 'Follow-Up Monitoring': 'Seguimiento',
    'Photo Note': 'Nota fotográfica', 'Add Photo to Timeline': 'Agregar foto a la cronología', 'Choose a photo first': 'Primero elija una foto', 'Documentation photo added': 'Foto de documentación agregada', 'Photo could not be added': 'No se pudo agregar la foto'
  };
