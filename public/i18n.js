(function () {
  ...
  function dynamic(text, lang) {
    ...
    const rules = lang === 'es' ? [
      ...
      [/^Current file format: (.+)$/, (_, format) => `Formato de archivo: ${format === 'Unknown' ? 'Desconocido' : format}`],
      ...
      [/^Formato de archivo: (.+)$/, (_, format) => `Current file format: ${format === 'Desconocido' ? 'Unknown' : format}`],
