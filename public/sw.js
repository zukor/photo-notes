const CACHE = 'efc-shell-v88';
const SHELL = ['/', '/index.html', '/i18n.js?v=74', '/app.js?v=88', '/styles.css?v=84', '/manifest.json', '/logo.svg', '/logo-animated.svg?v=83', '/tensor-man-badge.png', '/tensor-man-badge@2x.png', '/tensor-man-hover.png', '/tensor-man-hover@2x.png', '/tensor-man-open.png', '/tensor-man-open@2x.png', '/photo-notes-ai-paving-pro-animated.svg?v=79', '/photo-notes-ai-concrete-pro-animated.svg?v=77', '/photo-notes-ai-hoa-maintenance-pro-animated.svg?v=81', '/icon.svg', '/zukor-logo.svg', '/send.js?v=74', '/vendor/html2canvas.min.js?v=59'];
